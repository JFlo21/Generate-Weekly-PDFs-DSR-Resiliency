...
| 5 | Never commit claimer PII | not violated | Reports git-ignored; grep of added docs shows only fictional names + the D-12-E sample name approved by Juan in ROADMAP. |
