...
**Requirements**: SUB-08, SUB-09, SUB-10, SUB-11, SUB-12 (formalized
in REQUIREMENTS.md 2026-05-19 per `v1.0-MILESTONE-AUDIT.md`).
**Success Criteria** (what must be TRUE):
...
**Success Criteria** (what must be TRUE):
  ...
  4. `.planning/milestones/v1.0-INGEST-CONFLICTS-2026-05-14.md` INFO #8 (missing pre-migration
