...
- PDF POC: `poc/make_print_pdf_poc.py` (v1 demo) + `poc/build_wr_pdf.py` (v2,
  ...
  - `WR_18851047_..._Buddy_Mavin_PRINT.pdf` (3 days, $39,866.12, 6 pages — spill fixes verified)
  - `WR_16207306_..._Buddy_Mavin_PRINT.pdf` (2 days, $7,265.98, 2 pages)
  - `WR_19641091_..._Chris_Higginbotham_PRINT.pdf` (single-day real, earlier)
