...
Validates load_original_contract_rates() and the pricing reversion logic.
"""
...
class TestLoadOriginalContractRates(unittest.TestCase):
    """Tests for the load_original_contract_rates helper function."""
    ...
    def test_loads_valid_csv(self):
        ...
        try:
            rates = generate_weekly_pdfs.load_original_contract_rates(tmp_path)
    ...
    def test_missing_file_returns_empty(self):
        ...
        rates = generate_weekly_pdfs.load_original_contract_rates('/nonexistent/path.csv')
