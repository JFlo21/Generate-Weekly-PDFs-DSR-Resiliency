...
_Last updated: September 22, 2026 (updated automatically)_
...
- 📄 Help guides updated: project-state after PR ; 34.2 formal close-out pass; BUG-064 follow-ups plan
- 📄 Help guides updated: project-state after PRs / merged
- ✅ Problem fixed: run budget so a long sweep routes what it regenerated (BUG-064)
- ✅ Problem fixed: refuse revision-lane versions in the priced-sibling catch-up; WR-scoped dispatches get their own concurrency group
- ✅ Problem fixed: carry the ProMax row fill across GF hops; watcher maps the Billers + ledger env (BUG-062, BUG-063)
- ✅ Problem fixed: GF-edit watcher maps MANIFEST&#95;DECISION&#95;SYNC&#95;LIVE&#95;WRITE (BUG-061)
- 📄 Help guides updated: guardrail 4 wording + context-map close-out item 8
- • Phase 34.2: Audit routing + Output Log demotion (ROUT-01..04) + code-review fix round
...
- ✨ New capability: reviewer contract v2 -- task packet, bounded tracing, confidence, PR reconciliation
