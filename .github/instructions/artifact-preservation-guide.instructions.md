---
applyTo: '.github/workflows/*.yml,generated_docs/**'
description: "Use when: working on GitHub Actions artifacts, Excel report preservation, artifact manifest, hash history files, or CI/CD output organization."
---
